...
class PointNet2Trainer:
    ...
    def setup_model(self) -> None:
        ...
        self.model = PointNet2SemSeg(num_classes=2).to(self.device)
    ...
    def prepare_data(self, data_dir: Path) -> Tuple[DataLoader, DataLoader]:
        ...
        augmented_dir = data_dir / 'Augmented Data'
        augmented_files = list(augmented_dir.glob('*.npz')) if augmented_dir.exists() else []
...
def main():
    ...
    trainer = PointNet2Trainer(config)
