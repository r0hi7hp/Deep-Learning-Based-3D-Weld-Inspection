"""
Hybrid PointNet++ + Point Transformer Training Script - Production Ready
...
class HybridTrainer:
    """Trainer class for Hybrid PointNet++ + Point Transformer."""
    ...
    def setup_model(self) -> None:
        ...
        self.model = HybridPointNet(num_classes=2, num_heads=4).to(self.device)
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Train Hybrid Model for weld detection')
